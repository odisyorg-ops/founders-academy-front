...
const SupportChatWidget = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: "assistant", content: "Hi! 👋 I'm here to help you learn about The Founder Academy. Ask me anything about our programs, services, or how we can help you achieve your goals!" }
  ]);
